...
class TestMetaCaster(TestCase):
    ...
    def setUp(self):
        self.metapop_model = copy.deepcopy(TestMetaCaster._metapop_model)

    def tearDown(self):
        self.metapop_model = None

    def change_to_vaccination_dimensions(self):
    ...
    def test_ode(self):
        ...
        self.assertAlmostEqual(y_deltas[-2], 11.56857, 5)
        metapop_model_vaccination, y_vaccination, parameters_vaccination = self.change_to_vaccination_dimensions()
        ...
        self.assertAlmostEqual(y_deltas_vaccination[-2], 11.56857, 5)
